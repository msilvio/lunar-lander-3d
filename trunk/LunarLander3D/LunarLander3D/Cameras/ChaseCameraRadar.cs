...
namespace LunarLander3D
{
    class ChaseCameraRadar : Camera
    {
        ...
        public ChaseCameraRadar(Vector3 PositionOffset, Vector3 TargetOffset,
            ...
            : base(graphicsDevice)
        {
            ...
            this.altura = graphicsDevice.PresentationParameters.Bounds.Height / 4;
            this.largura = graphicsDevice.PresentationParameters.Bounds.Width / 4;
            this.posX = graphicsDevice.PresentationParameters.Bounds.X + 100;
            this.posY = graphicsDevice.PresentationParameters.Bounds.Y + 100;
        }
